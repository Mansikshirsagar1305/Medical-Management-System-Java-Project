...
public class Homepage extends JFrame implements ActionListener, FocusListener {
    ...
    private String[] images ={"home2.jpg", "sell2.jpg"};
    ...
    public Homepage() {
        ...
        backgroundPanel = new JPanel(null) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon backgroundImage = new ImageIcon(images[currentImageIndex]);
        ...
        searchdata.setFont(new Font("Serif",Font.BOLD,18));
        searchdata.setBounds(260, 50, 80, 30);
        searchdata.setForeground(Color.white);
         add(searchdata);
        ...
        pri.setFont(new Font("Serif",Font.BOLD,18));
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521/XEPDB1", "system", "manager");            
        ...
        try {
            ...
            psu = con.prepareStatement("update Medical set quantity=?,price_per=? where id=?");
            psd = con.prepareStatement("delete from Medical where id=?");
            pssell = con.prepareStatement("update Medical set quantity=? where id=?");
        ...
        if (ae.getSource() == ab) {
            ...
            try {
                ...
                if (!r.next()) {
                    ...
                    selledId.add(id_no);
                    selledQty.add(qtys);
                    st.executeQuery("delete from Medical where quantity=0");
                }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Bills Info Stored in Bills Table");
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        }
